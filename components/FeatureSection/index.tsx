...
export const FeatureSection = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row gap-8 w-4xl">
          <Card className="w-full md:w-1/2 p-6 sm:p-8 bg-transparent text-white shadow-[inset_0px_0px_20px_-3px_rgba(_255,_255,_255,.5)] h-80 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl">
        <Card className="p-4 sm:p-6 md:p-8 bg-transparent shadow-[inset_0px_2px_20px_-3px_rgba(_255,_255,_255,1)] hover:bg-purple-950 transition duration-600 ease-in-out h-62">
          <div>
        ...
        <Card className="p-4 sm:p-6 md:p-8 bg-transparent shadow-[inset_0px_2px_20px_-3px_rgba(_255,_255,_255,1)] hover:bg-purple-950 transition duration-600 ease-in-out">
          <div>
            <div className="w-12 h-12 bg-purple-700 rounded-lg flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Card className="p-4 sm:p-6 md:p-10 md:py-8 bg-transparent shadow-[inset_0px_2px_20px_-3px_rgba(_255,_255,_255,1)] hover:bg-purple-950 transition duration-600 ease-in-out h-62">
          <div>
        ...
        <Card className="col-span-1 md:col-span-2 p-4 sm:p-6 md:p-8 bg-purple-950 shadow-[inset_0px_2px_20px_-3px_rgba(_255,_255,_255,1)] h-62">
          <div>
