    ...
    <div className="flex flex-col items-center gap-8 mt-12 md:mt-16">
      ...
      >
        <div className="flex flex-col md:flex-row items-center mb-20 sm:mb-0 gap-8 relative">
          ...
          >
            <Card className="bg-transparent md:w-75 p-4 sm:p-6 mb-4 shadow-[8px_10px_15px_1px_rgba(0,0,0,1)]">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-y-8 sm:gap-y-0 gap-4 md:gap-10 md:mr-14">
          ...
          >
            <WobbleCard className="bg-transparent border-none w-full h-[300px]">
              ...
              <Image src={'/signup.png'} alt="Signup image" width={300} height={300} className="blur-[0.7px] -ml-10"/>
            </WobbleCard>
          </motion.div>
          ...
          >
            <Card className="bg-transparent md:w-75 p-4 sm:p-6 mt-16 sm:mt-0 shadow-[8px_10px_15px_1px_rgba(0,0,0,1)]">
              <div className="mx-2 md:mx-4">
                <motion.h2 
                  className="text-white text-xl md:text-2xl font-semibold"
                  initial={{ opacity: 0 }}
